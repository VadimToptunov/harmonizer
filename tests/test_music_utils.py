...
class TestMusicUtils(unittest.TestCase):
    ...
    def test_get_chord_tones(self):
        ...
        self.assertIn(60, tones)  # C
        self.assertIn(64, tones)  # E
        self.assertIn(67, tones)  # G

        # C minor
        tones = get_chord_tones(60, "minor")
        self.assertIn(60, tones)  # C
        self.assertIn(63, tones)  # Eb
        self.assertIn(67, tones)  # G
        ...
        self.assertIn(60, tones)  # C
        self.assertIn(63, tones)  # Eb
        self.assertIn(66, tones)  # Gb

    def test_get_chord_inversion(self):
        """Test chord inversion detection."""
        # Root position
        self.assertEqual(get_chord_inversion(60, [60, 64, 67]), 0)
        
        # First inversion
        self.assertEqual(get_chord_inversion(64, [60, 64, 67]), 1)
        
        # Second inversion
        self.assertEqual(get_chord_inversion(67, [60, 64, 67]), 2)

    def test_voice_enum(self):
        """Test Voice enum values."""
        self.assertEqual(Voice.SOPRANO, 0)
        self.assertEqual(Voice.ALTO, 1)
        self.assertEqual(Voice.TENOR, 2)
        self.assertEqual(Voice.BASS, 3)
